...
from oamlops.utils.databricks_utils import write_metadata
...
dbutils.widgets.text("session_name", "")
...
realignment_version = int(dbutils.widgets.get("realignment.version"))
...
predictions_df = (
   create_prediction_df(spark, inference_detections, inference_frame_indices, job_params)
    ...
    .withColumn("mlflow_inference_run_id", F.lit(""))
    .withColumn("mlflow_inference_experiment_id", F.lit(""))
    .repartition(1)
)
