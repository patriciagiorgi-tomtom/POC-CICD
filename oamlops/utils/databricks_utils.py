    ...
    spark.createDataFrame(
        ...
        schema="""
                ...
                classification struct<
                    mlflow_classification_run_id string,
                    mlflow_classification_experiment_id string,
                    mlflow_model_run_id string,
                    total_frames_with_inference integer,
                    total_inferences integer
                >,
                ...
                >
                """,
    ).write.format("delta").mode("append").option("mergeSchema", "true").save(run_metadata_table_path)
