...
from oamlops.model_manager.mmdet_visualization import MLflowVisBackendDatabricks
import mlflow
...
dbutils.widgets.text("inferencer_type", "DetInferencer") # ImageClassificationInferencer
dbutils.widgets.text("checkpoint_mlflow_run_id", "c4ddf6de80da4864bd85687aec176e26") # e52cc3b499e048b0a11d263ce3b3c993
...
# /Workspace/Repos/uhd_map/uhd_map/road_furniture/configs/mobileone/mobileone-s1_8xb32_in1k.py

dbutils.widgets.text("model_name", "DetInferencer_test") #Classifer_test
dbutils.widgets.text("device_type", "gpu")
dbutils.widgets.text("inference_image_width", '2666') #80
dbutils.widgets.text("inference_image_height", '1333') #80
